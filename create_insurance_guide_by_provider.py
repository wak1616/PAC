...
def main():
    ...
    with open("Insurance_Guide_By_Provider.md", "w", encoding='utf-8') as outfile:
    ...
    if os.path.exists(summary_path):
        ...
        while i < len(summary_lines):
            ...
            if line.strip() == provider_guide_title.strip():
                ...
                i += 1
                # Skip any existing indented insurance entries (let the other script handle them)
